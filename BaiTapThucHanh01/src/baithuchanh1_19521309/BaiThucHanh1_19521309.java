 ...
 * @author ASUS
 */
public class BaiThucHanh1_19521309 {
    ...
    public static void Bai5()
    {
        ...
        System.out.printf("So thu nhat: %.0f",a);
        System.out.printf("\nSo thu hai: %.0f",b);
    ...
    public static void Bai7()
    {
        ...
        System.out.print("Phan tu lon nhat trong ma tran la A[ = " +dongMax);
        ...
        System.out.println("\nMang cac so nguyen to cua ma tran la: ");
        for (int i = 0; i < dong; i++) 
        {
            for (int j = 0; j < cot; j++) 
            {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Chon 1 trong 7 chuc nang: ");
        Scanner sc = new Scanner(System.in);
        int n = sc.nextInt();
        switch(n)
        {
